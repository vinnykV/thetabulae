...
public class DBManagerServiceLocator extends org.apache.axis.client.Service implements DBManagerService {
    ...
    public DBManager getRxNormDBService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            RxNormDBServiceSoapBindingStub _stub = new RxNormDBServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DBManager.class.isAssignableFrom(serviceEndpointInterface)) {
                RxNormDBServiceSoapBindingStub _stub = new RxNormDBServiceSoapBindingStub(new java.net.URL(RxNormDBService_address), this);
                _stub.setPortName(getRxNormDBServiceWSDDServiceName());
                return _stub;
            }
