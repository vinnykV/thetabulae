...
public class Description  implements java.io.Serializable {
    ...
    /**
     * Gets the content value for this Description.
     * 
     * @return content
     */
    ...
    /**
     * Sets the content value for this Description.
     * 
     * @param content
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:BeanService", "Description"));
